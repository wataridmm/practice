...
このプロジェクトは画面上のボタンをタップすると「こんにちは」という文字列が表示されるアプリためのプロジェクトです。
==========================================================================
■ファイルの説明
...
ビューコントローラーファイル。ストーリーボードとの接続を行い、ボタンがタップされた際の処理を記述する。

Main.storyboard
ストーリーボードファイル。グラフィカルに画面にUIパーツを配置することができる。ラベルとボタンを配置し、ビューコントローラーファイルと接続を行う。
